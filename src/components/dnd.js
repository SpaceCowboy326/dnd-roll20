...
function calculateSlotLevelEffects(current_level, slot_level_effects) {
	console.log("slot effects?", slot_level_effects);
...
function calculateDamage(args) {
	...
	const current_player_level = document.getElementById("player_level").value;
	const current_slot_level = document.getElementById("slot_level").value;
	...
	if (player_level_effects) {
		...
		console.log("Player level does:", player_level_damage);
	}
	...
	if (slot_level_effects) {
		...
		console.log("Slot level does:", slot_level_damage);
	}

	const final_actual_damage = actual_damage.join(" + ");
	console.log("This spell will do this much damage total:", final_actual_damage);
